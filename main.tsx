...
const PRDIntakePage = () => {
  ...
  // Mengontrol state apakah file sudah diupload atau belum. 
  // Diset ke false sebagai default state (sebelum file di-drop).
  // Klik area drag & drop untuk mensimulasikan upload.
            ...
            {isUploaded && (
              <div className="bg-zinc-900/40 border border-zinc-800 rounded-xl flex flex-col overflow-hidden shadow-sm">
                ...
                <div className="p-6 overflow-y-auto max-h-[600px] text-sm text-zinc-300 space-y-8 bg-zinc-950/30">
                  ...
                  <div>
                    <h3 className="text-base font-medium text-zinc-200 mb-3 flex items-center gap-2">
                      <span className="text-zinc-600">2.</span> Objectives
                    </h3>
                    <ul className="list-disc pl-5 text-zinc-400 space-y-2">
                      <li><strong className="text-zinc-300">Adoption & Engagement:</strong> Increase daily active users utilizing the screener tool by 25%.</li>
                      <li><strong className="text-zinc-300">Usability:</strong> Reduce time-to-discovery for technical setups to under 60 seconds.</li>
                      <li><strong className="text-zinc-300">Data Integrity:</strong> Ensure 99.9% accuracy of fundamental ratios retrieved from the data vendor.</li>
                      <li><strong className="text-zinc-300">Non-advice Integrity:</strong> Strictly maintain neutral positioning; no automated buy/sell recommendations.</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    <h3 className="text-base font-medium text-zinc-200 mb-3 flex items-center gap-2">
                      <span className="text-zinc-600">3.</span> Functional Requirements (F1-F21)
                    </h3>
                    <div className="bg-zinc-900/50 border border-zinc-800 rounded-lg overflow-hidden">
                      <table className="w-full text-left text-sm">
                        <thead className="bg-zinc-900/80 border-b border-zinc-800">
                          <tr>
                            <th className="px-4 py-3 text-zinc-300 font-medium">ID</th>
                            <th className="px-4 py-3 text-zinc-300 font-medium">Feature</th>
                            <th className="px-4 py-3 text-zinc-300 font-medium">Description</th>
                          </tr>
                        </thead>
                        <tbody className="divide-y divide-zinc-800/50 text-zinc-400">
                          <tr><td className="px-4 py-2.5 font-mono text-xs">F1</td><td className="px-4 py-2.5 text-zinc-300">Popular Screener</td><td className="px-4 py-2.5">Pre-built screening templates based on popular metrics.</td></tr>
                          <tr><td className="px-4 py-2.5 font-mono text-xs">F2</td><td className="px-4 py-2.5 text-zinc-300">Add Filter</td><td className="px-4 py-2.5">Ability to append specific fundamental/technical criteria.</td></tr>
                          <tr><td className="px-4 py-2.5 font-mono text-xs">F3</td><td className="px-4 py-2.5 text-zinc-300">Technical Preset</td><td className="px-4 py-2.5">Golden cross, RSI oversold, MACD crossover presets.</td></tr>
                          <tr><td className="px-4 py-2.5 font-mono text-xs">F4</td><td className="px-4 py-2.5 text-zinc-300">Custom Preset</td><td className="px-4 py-2.5">Save user-defined screening criteria as a reusable preset.</td></tr>
                          <tr><td className="px-4 py-2.5 font-mono text-xs">F5</td><td className="px-4 py-2.5 text-zinc-300">Condition Builder</td><td className="px-4 py-2.5">Logical AND/OR grouping for complex filtering rules.</td></tr>
                          <tr><td className="px-4 py-2.5 font-mono text-xs">F6</td><td className="px-4 py-2.5 text-zinc-300">Universe</td><td className="px-4 py-2.5">Filter by index (LQ45, IDX30) or market cap tiers.</td></tr>
                          <tr><td className="px-4 py-2.5 font-mono text-xs">F7</td><td className="px-4 py-2.5 text-zinc-300">Result Table</td><td className="px-4 py-2.5">Sortable data grid with inline sparklines.</td></tr>
                          <tr><td className="px-4 py-2.5 font-mono text-xs">F8</td><td className="px-4 py-2.5 text-zinc-300">Backtest</td><td className="px-4 py-2.5">Simulate historical performance of custom screening rules.</td></tr>
                          <tr><td className="px-4 py-2.5 font-mono text-xs">F9</td><td className="px-4 py-2.5 text-zinc-300">Export</td><td className="px-4 py-2.5">Download results as CSV or PDF format.</td></tr>
                          <tr><td className="px-4 py-2.5 font-mono text-xs">F10</td><td className="px-4 py-2.5 text-zinc-300">Alerts</td><td className="px-4 py-2.5">Push notifications when new stocks enter/exit conditions.</td></tr>
                          <tr><td className="px-4 py-3 font-mono text-zinc-600 text-xs italic bg-zinc-950/50" colSpan="3">... 11 more features truncated for preview ...</td></tr>
                        </tbody>
                      </table>
                    </div>
                  </div>
                  ...
                  <div>
                    <h3 className="text-base font-medium text-zinc-200 mb-3 flex items-center gap-2">
                      <span className="text-zinc-600">4.</span> Architecture & Data Flow
                    </h3>
                    <div className="bg-zinc-900/50 p-5 border border-zinc-800 rounded-lg text-indigo-300/80 font-mono text-xs whitespace-pre overflow-x-auto leading-relaxed shadow-inner">
{`[Client App] --(1. Init Rule)--> [API Gateway] --(2. Validate)--> [Screener Service]
                  ...
                  <div>
                    <h3 className="text-base font-medium text-zinc-200 mb-3 flex items-center gap-2">
                      <span className="text-zinc-600">5.</span> Feature Gating (Free vs Premium)
                    </h3>
                    <p className="text-zinc-400 leading-relaxed bg-zinc-900/30 p-4 rounded border border-zinc-800/30">
                  ...
                  <div>
                    <h3 className="text-base font-medium text-zinc-200 mb-3 flex items-center gap-2">
                      <span className="text-zinc-600">6.</span> Appendices (Included in Parse)
                    </h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-zinc-400">
                      <div className="flex items-start gap-2 bg-zinc-900/30 p-2.5 rounded border border-zinc-800/50"><CheckCircle2 size={16} className="text-zinc-600 mt-0.5 shrink-0"/> Definitions & Glossary</div>
                      <div className="flex items-start gap-2 bg-zinc-900/30 p-2.5 rounded border border-zinc-800/50"><CheckCircle2 size={16} className="text-zinc-600 mt-0.5 shrink-0"/> Non-Functional Requirements</div>
                      <div className="flex items-start gap-2 bg-zinc-900/30 p-2.5 rounded border border-zinc-800/50"><CheckCircle2 size={16} className="text-zinc-600 mt-0.5 shrink-0"/> Release Plan</div>
                      <div className="flex items-start gap-2 bg-zinc-900/30 p-2.5 rounded border border-zinc-800/50"><CheckCircle2 size={16} className="text-zinc-600 mt-0.5 shrink-0"/> Acceptance Criteria</div>
                      <div className="flex items-start gap-2 bg-zinc-900/30 p-2.5 rounded border border-zinc-800/50"><CheckCircle2 size={16} className="text-zinc-600 mt-0.5 shrink-0"/> Constraints & Change Logs</div>
                    </div>
                  </div>
...
const ExplorerPage = () => {
  ...
  // $1 : 1.618 ≈ 38.2% : 61.8%
  // We use this for the split pane layout
...
// Helper for icon since we missed importing Paperclip
const PaperclipIcon = ({ size, className }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="m21.44 11.05-9.19 9.19a6 6 0 0 1-8.49-8.49l8.57-8.57A4 4 0 1 1 18 8.84l-8.59 8.57a2 2 0 0 1-2.83-2.83l8.49-8.48" />
  </svg>
);

const CoverageAuditPage = ({ setActiveRoute }) => {
  const steps = [
    ...
    <div className="flex h-full w-full bg-zinc-950 overflow-y-auto">
      <div className="max-w-5xl mx-auto w-full p-8 flex flex-col gap-8 pb-20 h-full">
        ...
        <div className="flex-1 min-h-[300px] border-2 border-dashed border-zinc-800/80 rounded-2xl p-12 flex flex-col items-center justify-center text-center bg-zinc-950/50 relative overflow-hidden group">
            {/* Background Noise/Gradient Simulation */}
...
const TestCataloguePage = ({ setActiveRoute }) => {
  const steps = [
    { id: 1, label: 'PRD Intake', icon: FileText, status: 'pending' },
    { id: 2, label: 'Coverage Audit', icon: ShieldCheck, status: 'pending' },
...
const QaseIntegrationPage = ({ setActiveRoute }) => {
  const steps = [
    { id: 1, label: 'PRD Intake', icon: FileText, status: 'pending' },
    { id: 2, label: 'Coverage Audit', icon: ShieldCheck, status: 'pending' },
    { id: 3, label: 'Test Catalogue', icon: Library, status: 'pending' },
...
const AIPlaygroundPage = () => {
  // Golden Ratio Layout: Chat (61.8%) | Configuration (38.2%)
...
const EmptyStatePage = ({ title, icon: Icon }) => (
  <div className="flex-1 h-full flex flex-col items-center justify-center text-zinc-500">
    <div className="w-16 h-16 rounded-2xl bg-zinc-900 border border-zinc-800 flex items-center justify-center mb-4 shadow-lg">
      <Icon size={32} className="text-zinc-600" />
    </div>
    <h2 className="text-xl font-semibold text-zinc-300 mb-2">{title}</h2>
    <p className="text-sm text-center max-w-md">
      This module is part of the overall specification but is currently represented as an empty state in this specific UI prototype to focus on the core workflow.
    </p>
  </div>
);
    ...
    <div className="flex h-full w-full bg-zinc-950 overflow-y-auto">
      <div className="max-w-4xl mx-auto w-full p-8 flex flex-col gap-6 pb-20">
        ...
        <div>
          ...
          <p className="text-sm text-zinc-500">Manage integrations, API keys, and generation policies.</p>
        </div>
          ...
          <div className="p-6 space-y-5 bg-zinc-900/20">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="space-y-2">
                <label className="text-xs font-medium text-zinc-400">Base URL (OpenAI-compatible)</label>
                <div className="relative">
                  <Globe size={14} className="absolute left-3 top-1/2 -translate-y-1/2 text-zinc-600" />
                  <input type="text" placeholder="https://api.openai.com/v1" className="w-full bg-zinc-950 border border-zinc-800 rounded-lg pl-9 pr-3 py-2 text-sm text-zinc-200 focus:outline-none focus:border-indigo-500 spring-transition" />
                </div>
              </div>
              <div className="space-y-2">
                <label className="text-xs font-medium text-zinc-400">API Token <span className="text-zinc-600 font-normal">(Optional)</span></label>
                <div className="relative">
                  <Key size={14} className="absolute left-3 top-1/2 -translate-y-1/2 text-zinc-600" />
                  <input type="password" placeholder="sk-..." className="w-full bg-zinc-950 border border-zinc-800 rounded-lg pl-9 pr-3 py-2 text-sm text-zinc-200 focus:outline-none focus:border-indigo-500 spring-transition" />
                </div>
              </div>
              <div className="space-y-2 md:col-span-2">
                <label className="text-xs font-medium text-zinc-400">Model</label>
                <div className="relative">
                  <Server size={14} className="absolute left-3 top-1/2 -translate-y-1/2 text-zinc-600" />
                  <input type="text" placeholder="gpt-4o" className="w-full bg-zinc-950 border border-zinc-800 rounded-lg pl-9 pr-3 py-2 text-sm text-zinc-200 focus:outline-none focus:border-indigo-500 spring-transition" />
                </div>
              </div>
            </div>
        ...
        <div className="bg-zinc-900/40 border border-zinc-800 rounded-xl overflow-hidden flex flex-col">
          <div className="p-5 border-b border-zinc-800 flex items-center justify-between bg-zinc-900/50">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-medium text-zinc-200">Qase Integration</h3>
                <p className="text-[10px] text-zinc-500 mt-0.5">API Base URL can be overridden server-side via QASE_BASE_URL. API Token is saved locally in your browser.</p>
              </div>
            </div>
          ...
          <div className="p-6 space-y-5 bg-zinc-900/20">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="space-y-2">
                <label className="text-xs font-medium text-zinc-400">API Base URL</label>
                <input type="text" placeholder="https://api.qase.io/v1" className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm text-zinc-200 focus:outline-none focus:border-emerald-500 spring-transition" />
              </div>
              <div className="space-y-2">
                <label className="text-xs font-medium text-zinc-400">API Token</label>
                <input type="password" placeholder="Enter Qase API Token" className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm text-zinc-200 focus:outline-none focus:border-emerald-500 spring-transition" />
              </div>
              <div className="space-y-2 md:col-span-2">
                <label className="text-xs font-medium text-zinc-400">Project</label>
                <div className="relative">
                  <select className="w-full bg-zinc-950 border border-zinc-800 rounded-lg pl-3 pr-10 py-2 text-sm text-zinc-200 focus:outline-none focus:border-emerald-500 appearance-none spring-transition">
        ...
        <div className="bg-zinc-900/40 border border-zinc-800 rounded-xl overflow-hidden flex flex-col">
          <div className="px-5 py-4 border-b border-zinc-800 bg-zinc-900/50 flex items-center justify-between">
            <h3 className="font-medium text-sm text-zinc-200">Qase Capability Matrix</h3>
            <Button variant="ghost" className="text-xs py-1 px-3 h-auto text-indigo-400 hover:text-indigo-300 hover:bg-indigo-500/10">Explore</Button>
          </div>
          
          {/* Card Body - Matrix Table */}
          <div className="overflow-x-auto bg-zinc-900/20">
            <table className="w-full text-left text-sm">
              <thead className="bg-zinc-950/50 border-b border-zinc-800">
                <tr>
                  <th className="px-5 py-3 text-xs font-medium text-zinc-400 uppercase tracking-wider">Resource</th>
                  <th className="px-5 py-3 text-xs font-medium text-zinc-400 uppercase tracking-wider">Endpoint</th>
                  <th className="px-5 py-3 text-xs font-medium text-zinc-400 uppercase tracking-wider">Status</th>
                  <th className="px-5 py-3 text-xs font-medium text-zinc-400 uppercase tracking-wider">Count</th>
                  <th className="px-5 py-3 text-xs font-medium text-zinc-400 uppercase tracking-wider text-right">Last Checked</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-zinc-800/50 text-zinc-300">
                <tr>
                  <td className="px-5 py-3 font-medium">Projects</td>
                  <td className="px-5 py-3 font-mono text-xs text-zinc-500">/project</td>
                  <td className="px-5 py-3 text-zinc-600">—</td>
                  <td className="px-5 py-3 text-zinc-600">—</td>
                  <td className="px-5 py-3 text-zinc-600 text-right">—</td>
                </tr>
                <tr>
                  <td className="px-5 py-3 font-medium">Suites</td>
                  <td className="px-5 py-3 font-mono text-xs text-zinc-500">/suite/&#123;projectCode&#125;</td>
                  <td className="px-5 py-3 text-zinc-600">—</td>
                  <td className="px-5 py-3 text-zinc-600">—</td>
                  <td className="px-5 py-3 text-zinc-600 text-right">—</td>
                </tr>
                <tr>
                  ...
                  <td className="px-5 py-3 font-mono text-xs text-zinc-500">/case/&#123;projectCode&#125;</td>
                  <td className="px-5 py-3 text-zinc-600">—</td>
                  <td className="px-5 py-3 text-zinc-600">—</td>
                  <td className="px-5 py-3 text-zinc-600 text-right">—</td>
                </tr>
                <tr>
                  <td className="px-5 py-3 font-medium flex items-center gap-2">Runs <span className="text-[10px] text-zinc-600 font-normal">(Optional)</span></td>
                  <td className="px-5 py-3 font-mono text-xs text-zinc-500">/run/&#123;projectCode&#125;</td>
                  <td className="px-5 py-3 text-zinc-600">—</td>
                  <td className="px-5 py-3 text-zinc-600">—</td>
                  <td className="px-5 py-3 text-zinc-600 text-right">—</td>
                </tr>
                <tr>
                  <td className="px-5 py-3 font-medium flex items-center gap-2">Defects <span className="text-[10px] text-zinc-600 font-normal">(Optional)</span></td>
                  <td className="px-5 py-3 font-mono text-xs text-zinc-500">/defect/&#123;projectCode&#125;</td>
                  <td className="px-5 py-3 text-zinc-600">—</td>
                  <td className="px-5 py-3 text-zinc-600">—</td>
                  <td className="px-5 py-3 text-zinc-600 text-right">—</td>
                </tr>
        ...
        <div className="bg-zinc-900/40 border border-zinc-800 rounded-xl overflow-hidden mb-8 flex flex-col">
          <div className="p-5 border-b border-zinc-800 flex items-center justify-between bg-zinc-900/50">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-medium text-zinc-200">QA Guidelines (Knowledge Base)</h3>
                <p className="text-[10px] text-zinc-500 mt-0.5">Standards injected as RAG Context during AI generation.</p>
              </div>
            </div>
            <Badge variant="brand" className="uppercase font-mono text-[10px] bg-blue-500/10 text-blue-400 border-blue-500/20">RAG Context</Badge>
          </div>
          
          {/* Card Body - Textarea */}
          <div className="p-6 bg-zinc-900/20">
            <textarea 
              className="w-full h-40 bg-zinc-950 border border-zinc-800 rounded-lg p-4 text-sm text-zinc-200 focus:outline-none focus:border-blue-500 resize-y spring-transition font-mono leading-relaxed"
